...
It's perfectly fine to re-use this definition in the munkireport application,
though.
...
# The 'info' argument we're passing to the password column contains
# metadata that Rum (http://python-rum.org/) can use generate an
